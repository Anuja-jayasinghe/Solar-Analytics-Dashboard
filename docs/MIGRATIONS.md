...
- The live trigger `trg_cascade_delete_ceb_data` (its definition is in the header of
  `2026-09-24_ceb_schema_drift.sql`, with the query to read it). The application no longer
  depends on it.
