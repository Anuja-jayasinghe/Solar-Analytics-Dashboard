> **Archived 2026-09-24 — this describes a system that was never built.** It specifies a Google Document AI pipeline. AI extraction was tried and deliberately abandoned; the real extractor is `pdfjs-dist` text extraction plus regex (`api/_lib/cebBillParser.js`). See [`ARCHITECTURE.md`](../../ARCHITECTURE.md).
