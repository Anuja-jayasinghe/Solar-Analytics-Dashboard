...
const TotalGenerationCard = () => {
  ...
  useEffect(() => {
    const fetchTotal = async () => {
      ...
      if (error) console.error("⚠️ Error fetching total generation:", error);
      else {
  ...
  return (
    <div style={{ ...cardStyle, background: "linear-gradient(135deg, #1a1a1a, #332800)" }}>
...
const valueStyle = { fontSize: "1.6rem", fontWeight: "bold", color: "#ffd700" };
